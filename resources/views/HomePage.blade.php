            ...
            <div class="d-flex">
                <div class="d-flex justify-content-between me-2">
                    <div class="input-group">
                        ...
                        <select class="form-select" id="scholasticFilter" name="scholasticId"></select>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between me-2">
                    <div class="input-group">
                        ...
                        <select class="form-select" name="majorId" id="majorFilter">
                    ...
                    <form action="" id="addSemesterForm">
                        <div class="input-group mb-3">
                            <input id="addSemesterInput" type="text" class="form-control"
                                ...
                                aria-describedby="button-addon2" name="TenHK">
                            <button class="btn btn-outline-primary" type="button" id="button-addon2">Thêm</button>
                        </div>
                        @csrf
                    </form>
                        ...
                        <form action="{{ route('major.add') }}" id="addMajorForm">
                            ...
                            <div class="input-group mb-3">
                                <input id="addMajorName_input" type="text" class="form-control"
                                    ...
                                    aria-describedby="button-addon2" name="TenNganh">
                                <button class="btn btn-outline-primary" type="submit" id="button-addon2">Thêm</button>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        function checkScholasticData() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (JSON.stringify(response) === JSON.stringify(currentScholasticData)) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                Object.keys(data).forEach(key => {
                                    ...
                                    // if (key == "0") {
                                    //     scholasticFilterOption.selected = true;
                                    // }
                    ...
                    currentScholasticData = response;
                }
            });
        }
        ...
        function checkSemesterData() {
            $.ajax({
                ...
                success: function(response) {
                    // So sánh dữ liệu trả về với dữ liệu hiện tại
                    if (JSON.stringify(response) === JSON.stringify(currentSemesterData)) {
        ...
        function checkMajorData() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    // So sánh dữ liệu trả về với dữ liệu hiện tại
                    if (JSON.stringify(response) === JSON.stringify(currentMajorData)) {
                        // console.log('Bảng học kì không thay đổi');
                    } else {
        ...
        function checkSubjectDetailData() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    // So sánh dữ liệu trả về với dữ liệu hiện tại
                    if (JSON.stringify(response) === JSON.stringify(currentSubjectDetailData)) {
                        // console.log(response);
                    } else {
                    ...
                    currentSubjectDetailData = response;
                }
            });
        }
                            ...
                            if (confirm(
                                ...
                                axios.get(url)
                                    .then(function(response) {
                                        ...
                                        document.getElementById("successAlert").classList
                                            .add("show");
        ...
        function checkSubjectData() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    // So sánh dữ liệu trả về với dữ liệu hiện tại
                    if (JSON.stringify(response) === JSON.stringify(currentSubjectData)) {
                        // console.log(response);
                    } else {
                        // var formData = document.getElementById("subjectDetailMemory").value;
                        // loadData(formData);
